...
class _NearByHotelsState extends State<NearByHotels> {
  double latitude = hotels[0].latitude;
  double longitude = hotels[0].longitude;
  ...
  void initState() {
    ...
    _markers.add(
      Marker(
        ...
        infoWindow: InfoWindow(title: hotels[currentHotelIndex].hotelName),
      ),
    );
  }
              ...
              child: PageView.builder(
                onPageChanged: (value) {
                  ...
                  setState(() {
                    ...
                    latitude = hotels[value].latitude;
                    longitude = hotels[value].longitude;
                    _markers.clear();
                    _markers.add(
                      Marker(
                        markerId: MarkerId('1'),
                        ...
                        infoWindow: InfoWindow(
                            title: hotels[currentHotelIndex].hotelName),
                      ),
                    );
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              width: 180,
                              child: Text(
                                hotels[index].hotelName.toString(),
                                style: TextStyle(
                            ...
                            Container(
                              width: 170,
                              child: Text(
                                hotels[index].addressName.toString(),
