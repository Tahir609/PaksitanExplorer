...
class DetailsRecentlyPlaces extends StatefulWidget {
  const DetailsRecentlyPlaces({super.key});

  @override
  State<DetailsRecentlyPlaces> createState() => _DetailsRecentlyPlacesState();
}

class _DetailsRecentlyPlacesState extends State<DetailsRecentlyPlaces> {
