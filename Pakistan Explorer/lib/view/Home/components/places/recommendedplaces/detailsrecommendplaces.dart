...
class DetailsRecomendedPlaces extends StatefulWidget {
  const DetailsRecomendedPlaces({super.key});

  @override
  State<DetailsRecomendedPlaces> createState() =>
      _DetailsRecomendedPlacesState();
}

class _DetailsRecomendedPlacesState extends State<DetailsRecomendedPlaces> {
