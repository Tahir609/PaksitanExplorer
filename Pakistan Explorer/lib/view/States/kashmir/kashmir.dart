...
class Kashmirstate extends StatefulWidget {
  Kashmirstate({super.key});

  @override
  State<Kashmirstate> createState() => _Kashmirstate();
}

class _Kashmirstate extends State<Kashmirstate> {
  final CollectionReference kashmir =
