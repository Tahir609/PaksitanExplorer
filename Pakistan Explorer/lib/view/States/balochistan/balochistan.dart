...
class Balochistanstate extends StatefulWidget {
  Balochistanstate({super.key});

  @override
  State<Balochistanstate> createState() => _Balochistanstate();
}

class _Balochistanstate extends State<Balochistanstate> {
  final CollectionReference balochistan =
      FirebaseFirestore.instanceFor(app: Firebase.app('learn'))
          .collection('balochistan');
  @override
