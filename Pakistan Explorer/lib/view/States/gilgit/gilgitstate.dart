...
class Gilgitstate extends StatefulWidget {
  Gilgitstate({super.key});

  @override
  State<Gilgitstate> createState() => _Gilgitstate();
}

class _Gilgitstate extends State<Gilgitstate> {
  final CollectionReference gilgit =
      FirebaseFirestore.instanceFor(app: Firebase.app('learn'))
          .collection('gilgit-Baltistan');
  @override
